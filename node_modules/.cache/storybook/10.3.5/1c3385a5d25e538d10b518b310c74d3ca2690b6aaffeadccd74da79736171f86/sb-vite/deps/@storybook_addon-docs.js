...
import { st as definePreviewAddon10 } from "./components-rLFPiCms.js";
import { t as DocsRenderer } from "./chunk-OATZR77O-CpLprGFd.js";
...
var excludeTags = Object.entries(globalThis.TAGS_OPTIONS ?? {}).reduce((acc, entry) => {
	...
	renderer: async () => {
		let { DocsRenderer } = await import("./DocsRenderer-LL677BLK-DqMgtU89.js");
