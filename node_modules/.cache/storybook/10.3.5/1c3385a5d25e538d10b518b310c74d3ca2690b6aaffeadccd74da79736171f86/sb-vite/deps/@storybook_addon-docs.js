...
import { st as definePreviewAddon10 } from "./components-C4kFZcRx.js";
import { t as DocsRenderer } from "./chunk-OATZR77O-UNCqrmIp.js";
...
var excludeTags = Object.entries(globalThis.TAGS_OPTIONS ?? {}).reduce((acc, entry) => {
	...
	renderer: async () => {
		let { DocsRenderer } = await import("./DocsRenderer-LL677BLK-DPL6z2Py.js");
