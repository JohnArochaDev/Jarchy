...
var LazyColorControl = (0, import_react.lazy)(() => import("./Color-FRDS63T2-IaYSuyO3.js")), ColorControl = (props) => import_react.createElement(import_react.Suspense, { fallback: import_react.createElement("div", null) }, import_react.createElement(LazyColorControl, { ...props }));
var Controls2 = {
	array: ObjectControl,
...
var PositionedToolbar = styled(Toolbar)({
	...
	let [expanded, setExpanded] = (0, import_react.useState)(isExpanded), [copied, setCopied] = (0, import_react.useState)(null), [scale, setScale] = (0, import_react.useState)(1), additionalActionItems = (0, import_react.useMemo)(() => additionalActions ? [...additionalActions] : [], [additionalActions]), sourceId = $bdb11010cef70236$export$f680877a34711e37(), previewClasses = [className].concat([
		...
		let { createCopyToClipboardFunction } = await import("./components-BRhSA9Ud.js");
...
//# sourceMappingURL=blocks-DPqsRRwy.js.map